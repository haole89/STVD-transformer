...
"""
def high_downscale_compress(input_path, input_file, output_path, type_T):
...
"""
def flipping(input_path, input_file, output_path):
    ...
    output_name = output_path + "\\" + input_file.split('.')[0] + "_D3.mp4"
    ...
    return
# ----------------------------------------------------------------------------------------------------
def rotating(input_path, input_file, output_path):
    ...
    out_filename = input_file.split('.')[0] + "_D4.mp4"
    ...
    return
# ----------------------------------------------------------------------------------------------------
def add_blackboder(input_path, input_file, output_path):
    ...
    out_filename = input_file.split('.')[0] + "_D5.mp4"
...
def global_tranformation(input_path, input_file, output_path):    
    # set D
    # flipping: Yes/no
    # rotating: 
    # black border: 
    ...
    if(method == 1):
        flipping(input_path, input_file, output_path)
    if(method == 2):
        rotating(input_path, input_file, output_path)
    if(method == 3):
        add_blackboder(input_path, input_file, output_path)            
    return
# ----------------------------------------------------------------------------------------------------
